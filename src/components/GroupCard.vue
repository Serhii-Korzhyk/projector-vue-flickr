      ...
      >
        ...
        >
          <v-card-title class="align-end fill-height">
            <p v-if="image.title" class="image-title">{{ group.title }}</p>
            <p v-else class="image-title">No Title Found</p>
          </v-card-title>
        </v-img>

        <v-card-text>
          <span class="image-date">{{ group.datetaken | moment}}</span><br>
          <span class="text--primary">
            <span class="image-views">Views: {{ group.views }}</span><br>
            <span class="image-owner">By {{ group.ownername }}</span>
          </span>
        </v-card-text>
